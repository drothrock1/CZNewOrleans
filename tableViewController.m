...
- (void)viewDidLoad {
	...
	NSDictionary *row6 = [[NSDictionary alloc] initWithObjectsAndKeys:@"6. Muriel's", @"Name", @"801 Chartres Street",@"Address",@"nolactable6",@"Image",  nil];	
	NSDictionary *row7 = [[NSDictionary alloc] initWithObjectsAndKeys:@"7. Pirate's Alley Cafe", @"Name", @"622 Pirate's Alley",@"Address",@"nolactable7",@"Image",  nil];	
	NSDictionary *row8 = [[NSDictionary alloc] initWithObjectsAndKeys:@"8. Maison Bourbon", @"Name", @"641 Bourbon Street",@"Address",@"nolactable8",@"Image",  nil];
    NSDictionary *row9 = [[NSDictionary alloc] initWithObjectsAndKeys:@"9. Hermes Bar", @"Name", @"725 Rue St Louis",@"Address",@"nolactable9",@"Image",  nil];
	NSDictionary *row10 = [[NSDictionary alloc] initWithObjectsAndKeys:@"10. Napoleon House", @"Name", @"500 Chartres Street",@"Address",@"nolactable10",@"Image",  nil];
    NSDictionary *row11 = [[NSDictionary alloc] initWithObjectsAndKeys:@"11. Kingfish", @"Name", @"337 Chartres Street",@"Address",@"nolactable11",@"Image",  nil];
    NSDictionary *row12 = [[NSDictionary alloc] initWithObjectsAndKeys:@"12. SoBou", @"Name", @"310 Chartres Street",@"Address",@"nolactable12",@"Image",  nil];
