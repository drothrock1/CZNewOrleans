...
- (void) prevController {
	...
	PageTwelveViewController *pagetwelveVC = [[PageTwelveViewController alloc] initWithNibName: @"PageTwelveViewController" bundle:nil];
	...
	pagetwelveVC.hidesBottomBarWhenPushed = YES;
	[navigationStack addObject:pagetwelveVC];
	
	[pagetwelveVC release];
...
-(void)loadAudioFile {
	...
	// Load the audio file
	if(player == nil){	
		NSString *audioFile = [NSString stringWithFormat:@"nola1"];
