...
@interface PageTwelveViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
@implementation PageTwelveViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.title = NSLocalizedString(@"Site 12", @"");
...
- (void)viewDidLoad
{
	...
	[scrollView setContentSize:CGSizeMake(320, 2200)];
...
-(void)loadAudioFile {
	...
	// Load the audio file
	if(player == nil){
		NSString *audioFile = [NSString stringWithFormat:@"nolac12"];
